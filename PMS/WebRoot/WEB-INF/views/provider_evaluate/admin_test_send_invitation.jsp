...
<!--zhemin 添加class="easyui-layout"-->
<body class="easyui-layout">
    <!--zhemin 添加style="width:100%;height:100%;-->
    <table id="test_send_dg" style="width:100%;height:100%;" data-options="
                rownumbers:true,
                singleSelect:false,
                autoRowHeight:true,
                pagination:true,
    ...
    <div id="test_send_tb" style="padding:0 30px;">
        <div class="conditions">
            ...
            <a  class="easyui-linkbutton" iconCls="icon-add">批量发送</a>
    ...
    function getData() {
        ...
        for (var i = 1; i <= 80; i++) {
            rows.push({
                ...
                code: '16S13700010695',
                planNum:'16S13700010695',
                name: '16S13700010695',
                level: '2017-2-14',
                provide: '中软国际有限公司',
                status: '<a href="<%=basePath%>admin/progroup/proaudit/msgSend.do" class="easyui-linkbutton" data-options="selected:true">发送邀请函</a>',
                note: '备注'
            });
        }
        return rows;

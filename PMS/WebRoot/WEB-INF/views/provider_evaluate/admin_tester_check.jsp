       ...
       <table id="dg" style="width:100%"  data-options="
            ...
            <thead>
                <tr>
                    ...
                    <th field="code" width="10%">考评安排号</th>
                    <th field="supcode" width="10%">供应商编码</th>
        ...
        <div class="conditions">
            <a href="<%=basePath%>admin/progroup/proaudit/evaluPerFilter.do" class="easyui-linkbutton" data-options="iconCls:'icon-back'">返回</a>
        ...
        function getData(){
            ...
            for(var i=1; i<=10; i++){
                rows.push({
                    ...
                    appdate: '部门经理',
                    procheck:'中石油沈阳分公司',
                    del:'<a href="#" class="easyui-linkbutton" data-options="selected:true">删除</a>'

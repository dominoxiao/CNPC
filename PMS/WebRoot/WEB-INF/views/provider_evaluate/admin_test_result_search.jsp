...
<!--                 <th data-options="field:'ck',checkbox:true">全选</th> -->
                ...
                <th field="adjust" width="12">调整考评结果</th>
                <th field="send" width="12">发送考评结果</th>
            </tr>
        </thead>
    </table>
    <div id="tb" style="padding:0 30px;">
        <div class="conditions">
            ...
            <!--  -->
            <a href="<%=basePath%>admin/progroup/proaudit/setParam.do" class="easyui-linkbutton" iconCls="icon-add">设置评级参数</a>
        </div>
    ...
    function getData() {
        ...
        for (var i = 1; i <= 20; i++) {
            rows.push({
                ...
                timeend: '2017-2-14',
                year: '2017年',
                adjust: '<a href="<%=basePath%>admin/progroup/proaudit/adjustScore.do" class="easyui-linkbutton" data-options="selected:true">调整</a>',
                send: '<a href="<%=basePath%>admin/progroup/proaudit/sendResult.do" class="easyui-linkbutton" data-options="selected:true">发送</a>'
            });
        }
        return rows;
    }

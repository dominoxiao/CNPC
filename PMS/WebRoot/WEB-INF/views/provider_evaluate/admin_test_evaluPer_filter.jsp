    ...
    <table id="dg" style="width:100%;height:100%;" data-options="
        ...
        <thead>
            <tr>
                ...
                <th field="depName" width="170">地区相关部门名称</th>
                <th field="status" width="120">筛选考评人员</th>
    ...
    function getData() {
        ...
        for (var i = 1; i <= 80; i++) {
            rows.push({
                ...
                provide: '中软国际有限公司',
                depName: '中石油兰州分公司',
                status: '<a href="<%=basePath%>admin/progroup/proaudit/testerCheck.do" class="easyui-linkbutton" data-options="selected:true">筛选考评人员</a>',
                note: '备注'
            });
        }
        return rows;

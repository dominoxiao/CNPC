		...
		<div class="content">
			<div class="easyui-tabs1" style="width:100%;">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
				...
				<div class="query"><a href="<%=basePath%>admin/progroup/proaudit/resultSearch" class="easyui-linkbutton"  data-options="selected:true">查看考评情况</a></div>
				<div class="submit">
			        ...
			        <a href="<%=basePath%>progroup/improve/adm_choose_sup.do" class="easyui-linkbutton"  data-options="selected:true">返回</a>
			    </div>

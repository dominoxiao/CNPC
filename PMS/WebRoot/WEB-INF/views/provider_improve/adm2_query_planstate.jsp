...
<body>
    <div class="container" style="position:absolute;padding:10px;width:98%;height:94%;overflow:hidden">
      ...
      <div id="tb" style="padding:0 30px;display:none">
        ...
        <div>
            ...
            <span class="query-con">专业工作组名称</span><input class="easyui-textbox" type="text" name="name" style="width:166px;height:35px;line-height:35px;"></input>
    ...
    <script type="text/javascript">
        ...
        {
          return "<a href='<%=basePath%>auditcommit/improve/adm2_query_page.do'>查看</a>&nbsp;&nbsp;"+
                 "<a href='<%=basePath%>auditcommit/improve/adm2_appr_plan.do'>审批</a>&nbsp;&nbsp;";
        }
    </script>
</body> 
</html>

		...
		<div class="content">
			<div class="easyui-tabs1" style="width:100%;">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
		      	<div class="column"><span class="current">填写改进结果</span></div>
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
						    ...
						    <td class="kv-content"><a href="../images/dot.png" download="证明文件">附件下载</a></td>
						</tr>
						<tr>
						...
						<tr>
						    ...
						    <td class="kv-content" colspan=5><textarea class="write">通过</textarea></td>
						</tr>
						<tr>
						    <td class="kv-label">改进是否完成</td>
							<td class="kv-content"><input type="radio" name="result1" checked="checked">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result1">否</td>
							<td class="kv-label">是否重新评级</td>
							<td class="kv-content"><input type="radio" name="result" checked="checked">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result">否</td>
							<td class="kv-label">填报人</td>
							<td class="kv-content"><input type="text" value="张华"/></td>
						</tr>

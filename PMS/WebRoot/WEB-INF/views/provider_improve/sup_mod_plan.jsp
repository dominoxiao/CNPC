		...
		<div class="content">
			<div class="easyui-tabs1" style="width:100%;">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
		      	<div class="column"><span class="current">填写改进计划</span></div>
		      	<table class="kv-table">
					<tbody>
						<tr>
							<td class="kv-label">改进计划编号</td>
							<td class="kv-content">178ADGU89032</td>
							<td class="kv-label">填写日期</td>
						...
						<tr>
							...
							<td class="kv-content"><input id="date" type="text" class="easyui-datebox"  value="2017-2-20"/></td>
						</tr>
						<tr>
						    <td class="kv-label">问题概述</td>
						    <td class="kv-content" colspan=3><div class="setscroll">质量问题</div></td>
						</tr>
						<tr>
						    <td class="kv-label">改进要求</td>
						    <td class="kv-content" colspan=3><div class="setscroll">改进质量</div></td>
						</tr>
						<tr>
						    <td class="kv-label">原因分析</td>
						    <td class="kv-content" colspan=5><textarea class="write">材料问题</textarea></td>
						</tr>
						<tr>
						    <td class="kv-label">改进方案</td>
						    <td class="kv-content" colspan=5><textarea class="write">严查材料质量</textarea></td>
						</tr>
						<tr>
						    <td class="kv-label">证明文件(可选)</td>
						    <td class="kv-content" colspan=5><span class="fileload"><input class="easyui-filebox" name="business_license" accept=""></td>
						</tr>
					</tbody>
				</table>
				<div class="submit">
				    <a href="#" class="easyui-linkbutton"  data-options="selected:true">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
			        <a href="<%=basePath%>provider/sup_query_planstate.do" class="easyui-linkbutton"  data-options="selected:true">返回</a>
			    </div>
		      </div>
		    </div>
		</div>

		...
		<div class="content">
			<div class="easyui-tabs1" style="width:100%;">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
		      	<div class="column"><span class="current">改进结果审批</span></div>
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
						    ...
						    <td class="kv-content" colspan=5><a href="../images/dot.png" download="证明文件">附件下载</a></td>
						</tr>
						<tr>
						...
						<tr>
						    ...
						    <td class="kv-content" colspan=5>通过</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="kv-content"><input type="radio" name="result1">通过&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result1">不通过</td>
							<td class="kv-label">升级审批</td>
							<td class="kv-content">
							<input type="radio" name="result">通过&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result">不通过</td>
				...
				<div class="submit">
			        ...
			        <a href="<%=basePath%>auditcommit/improve/adm2_query_planstate.do" class="easyui-linkbutton"  data-options="selected:true">返回</a>
			    </div>

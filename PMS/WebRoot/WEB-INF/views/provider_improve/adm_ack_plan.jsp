		...
		<div class="content">
			<div class="easyui-tabs1" style="width:100%;">
		      <div title="基本信息" data-options="closable:false" class="basic-info">
		      	<div class="column"><span class="current">改进方案确认</span></div>
		      	<table class="kv-table">
					<tbody>
						...
						<tr>
							...
							<td class="kv-content"><input type="text"/></td>
							<td class="kv-label">评审结果</td>
							<td class="kv-content" colspan=4><input type="radio" name="result">通过&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="result">不通过</td>
							</tr>
					</tbody>
				</table>
				<div class="submit">

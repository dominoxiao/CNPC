...
<body>
    <div class="container" style="position:absolute;padding:10px;width:98%;height:94%;overflow:hidden" >
       <table id="dg" style="width:100%;height:100%;display:none" title="改进计划查询" data-options="
            ...
            <thead>
                <tr>
                    <th field="suppliercode" width="80">改进计划编号</th>
                    <th field="suppliername" width="150">供应商名称</th>
                    <th field="productname" width="80">产品名称</th>
                    <th field="productcode" width="100">专业工作组名称</th>
      ...
      <div id="tb" style="padding:0 30px;display:none">
        <div class="conditions">
            ...
            <span class="query-con">供应商名称</span><input class="easyui-textbox" type="text" name="name" style="width:166px;height:35px;line-height:35px;"></input>
        ...
        <div>
            ...
            <select class="easyui-combobox" type="text" name="code" panelHeight="120" style="width:160px;height:35px;line-height:35px;">
    ...
    <script type="text/javascript">
        ...
        {
          return "<a href='<%=basePath%>progroup/improve/adm_query_page.do'>查看</a>&nbsp;&nbsp;"+
                 "<a href='<%=basePath%>progroup/improve/adm_mod_plan.do'>修改</a>&nbsp;&nbsp;"+
                 "<a href='<%=basePath%>progroup/improve/adm_cancel_plan.do'>撤销</a>&nbsp;&nbsp;"+
                 "<a href='<%=basePath%>progroup/improve/adm_ack_plan.do'>审批</a>&nbsp;&nbsp;"+
                 "<a href='<%=basePath%>progroup/improve/adm_edit_result.do'>填写改进结果</a>";
        }
    </script>
</body> 
</html>

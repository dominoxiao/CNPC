...
<div class="opt-buttons" style="padding-bottom:10px">
	...
	<div class="easyui-tabs1">
      <div title="战略物资核准" data-options="closable:false" class="basic-info">
      	<table class="kv-table">
			<tbody>
				<tr>
					<td class="kv-label">申请编号</td>
					<td class="kv-content">2816040820001</td>
					<td class="kv-label">核准时间</td>
					<td class="kv-content">2016-10-15</td>
					<td class="kv-label">核准机构</td>
					<td class="kv-content">总部物采部</td>
				</tr>
			
				<tr>
					<td class="kv-label">核准意见</td>
				...
				<tr>
							<td colspan="8" style="text-align: center; height: 50px">
                                    <!-- colspan 单元格合并 --><a href="<%=basePath%>admin/buydept/backmate.do" class="easyui-linkbutton" data-options="selected:true" style="margin-right: 20px">通&nbsp;&nbsp;过</a>
                                    <a href="<%=basePath%>admin/buydept/backmate.do" class="easyui-linkbutton" data-options="selected:true">不通过</a> <a href="<%=basePath%>admin/buydept/backmate.do" class="easyui-linkbutton" style="margin-left: 20px">返&nbsp;&nbsp;回</a>
                   				</td>
				</tr>
			</tbody>
		</table>

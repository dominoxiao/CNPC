...
<html>
  ...
  <body>
    <div class="container">
       <table id="dg" style="width:100%;" title="战略物资评审" data-options="
                rownumbers:true,
                singleSelect:false,
                autoRowHeight:false,
                pagination:true,
        ...
        function getData(){
            ...
            for(var i=1; i<=800; i++){
                rows.push({
                    ...
                    check:'<a href="<%=basePath%>admin/auditcommit/reviewmate2.do" class="easyui-linkbutton" data-options="selected:true">评审</a>'
                });
            }
            return rows;
        }

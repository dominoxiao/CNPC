...
<div class="opt-buttons" style="padding-bottom:10px">
	...
	<div class="easyui-tabs1">
      <div title="战略物资评审" data-options="closable:false" class="basic-info">
			...
			<tbody>
				...
				<tr>
							<td colspan="8" style="text-align: center; height: 50px">
                                    <!-- colspan 单元格合并 --><a href="<%=basePath%>admin/auditcommit/backmate.do" class="easyui-linkbutton" data-options="selected:true" style="margin-right: 20px">通&nbsp;&nbsp;过</a>
                                    <a href="<%=basePath%>admin/auditcommit/backmate.do" class="easyui-linkbutton" data-options="selected:true">不通过</a> <a href="<%=basePath%>admin/auditcommit/backmate.do" class="easyui-linkbutton" style="margin-left: 20px">返&nbsp;&nbsp;回</a>
                   				</td>
				</tr>
			</tbody>
		</table>

...
<html>
  ...
  <body>
    <div style="position:absolute;padding:10px;width:98%;height:94%;overflow:hidden">
        <table id="dg" style="width: 100%;height:100%; display: none" title="冻结信息审核" data-options="
                rownumbers:true,
                singleSelect:false,
                autoRowHeight:false,
                pagination:true,
    ...
    function getData() {
        ...
        for (var i = 1; i <= 80; i++) {
            rows.push({
                ...
                subtime: '2016-06-01',
                status: '未审核',
                check: '<a href="<%=basePath%>admin/material_review_frozen_check.do" class="easyui-linkbutton" data-options="selected:true">审核</a>'
            });
        }
        return rows;
    }

    ...
    <div style="position:absolute;padding:10px;width:98%;height:94%;overflow:hidden">
        <table id="dg" style="width: 100%; height:100%; display:none;" title="淘汰供应商列表" data-options="
            ...
            <thead>
                <tr>
                    ...
                    <th field="reason" width="170">淘汰原因</th>
        ...
        <div id="tb" style="padding: 0 30px;display: none">
            <div class="conditions">
                ...
                <input class="easyui-textbox" type="text" name="name" style="width: 166px; height: 35px; line-height: 35px;"></input> <a class="easyui-linkbutton" iconCls="icon-search" data-options="selected:true">查询</a> <a class="easyui-linkbutton" iconCls="icon-reload">重置</a> <a  class="easyui-linkbutton more" iconCls="icon-more">更多</a>
            </div>
            ...
            <div class="conditions hide">
                ...
                <select class="combobox" name="language" style="height: 35px; width: 166px;">
                    ...
                    <option>C</option>
                    <option>不及格</option>
                </select> <span class="con-span">&nbsp&nbsp淘汰类型:</span>&nbsp&nbsp
                <select class="combobox" name="language" style="height: 35px; width: 166px;">
                    <option>--------请选择--------</option>
                    <option>主动要求退出的供应商</option>
                    <option>在供货过程中存在问题的供应商</option>
                    <option>倒闭、被并购等情况导致已经不存在的供应商</option>
            ...
            <div class="opt-buttons">
                &nbsp&nbsp&nbsp <a href="<%=basePath%>admin/profess_die_submit_add.do" class="easyui-linkbutton" data-options="selected:true">新增淘汰信息</a> <a class="easyui-linkbutton">导出淘汰信息</a>
            </div>
        </div>
        ...
        function getData() {
            ...
            for (var i = 1; i <= 80; i++) {
                rows.push({
                    ...
                    date: '2016-03-01',
                    status: '已审核',
                    operation: '<a href="<%=basePath%>admin/profess_die_submit_select.do" class="easyui-linkbutton" data-options="selected:true">查看</a><a class="easyui-linkbutton" data-options="selected:true">淘汰</a>'
                });
            }
            return rows;
        }

        ...
        <div class="content">
            <div class="easyui-tabs1" style="width: 100%;">
                <div title="基本信息" data-options="closable:false" class="basic-info">
                    <div class="column">
                        <span class="current">提交解冻信息</span>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" style="text-align: center; height: 50px">
                                    <!-- colspan 单元格合并 --><a href="<%=basePath%>admin/profess_thaw_submit.do" class="easyui-linkbutton" data-options="selected:true">提&nbsp;&nbsp;交</a>
                                    <a href="<%=basePath%>admin/profess_thaw_submit.do" class="easyui-linkbutton" style="margin-left: 20px">返&nbsp;&nbsp;回</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>

...
<html>
  ...
  <body>
    <div style="position:absolute;padding:10px;width:98%;height:94%;overflow:hidden">
        <table id="dg" style="width: 100%; height: 100%; display: none" title="解冻供应商列表" data-options="
                rownumbers:true,
                singleSelect:false,
                autoRowHeight:false,
                pagination:true,
            ...
            <thead>
                <tr>
                    ...
                    <th field="reason" width="170">解冻原因</th>
        ...
        <div id="tb" style="padding: 0 30px;display: none">
            ...
            <div class="conditions hide">
                ...
                <select class="combobox" name="language" style="height: 35px; width: 166px;">
                    ...
                    <option>C</option>
                    <option>不及格</option>
                </select> <span class="con-span">&nbsp&nbsp解冻类型:</span>&nbsp&nbsp
                <select class="combobox" name="language" style="height: 35px; width: 166px;">
                    <option>--------请选择--------</option>
                    <option>供应商绩效升级</option>
                    <option>供应商准入新的产品</option>
                    <option>供应商申请解冻</option>
        ...
        function getData() {
            ...
            for (var i = 1; i <= 80; i++) {
                rows.push({
                    ...
                    date: '2016-03-01',
                    status: '已审核',
                    operation: '<a href="<%=basePath%>admin/profess_thaw_submit_select.do" class="easyui-linkbutton" data-options="selected:true">查看</a><a href="<%=basePath%>admin/profess_thaw_submit_apply.do" class="easyui-linkbutton" data-options="selected:true">提交</a><a class="easyui-linkbutton" data-options="selected:true">解冻</a><a class="easyui-linkbutton" data-options="selected:true">通知</a>'
                });
            }
            return rows;
        }
